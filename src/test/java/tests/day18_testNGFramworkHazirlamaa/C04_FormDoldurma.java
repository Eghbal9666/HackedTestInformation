...
public class C04_FormDoldurma {
        ...
        public void formDoldurmaTesti(){
            ...
            Select selectGun = new Select(testotomasyonuFormPage.dayDropDown);
            selectGun.selectByIndex(5);

            //3- Dogum tarihi ay seçeneğinden value kullanarak Nisan’i secin

            Select selectAy = new Select(testotomasyonuFormPage.monthDropDown);
            selectAy.selectByValue("nisan");

            //4- Dogum tarihi yil seçeneğinden visible text kullanarak 1990’i secin
            Select selectYil = new Select(testotomasyonuFormPage.yearDropDown);
